						...
						<div class="shop-desc-container"> 
							...
							<div class="shop-desc <?php echo esc_attr($shoplayout);?>"> 
								<div class="shop_header"> 
									<?php if( isset($javenist_opt['bg_shop']['url']) && $javenist_opt['bg_shop']['url']!=''){ ?>
										<div class="bg-shop"><img src="<?php echo esc_url($javenist_opt['bg_shop']['url'])?>" /></div>
									<?php } ?> 
								</div> 
							</div>
								...
								<?php if ( woocommerce_products_will_display() ) { ?>
									<div class="toolbar">
										<div class="toolbar-inner">
											<div class="view-mode">
												<label><?php esc_html_e('View on', 'javenist');?></label>
												<a href="#" class="grid <?php if($javenist_viewmode=='grid-view'){ echo ' active';} ?>" title="<?php echo esc_attr__( 'Grid', 'javenist' ); ?>"></a>
												<a href="#" class="list <?php if($javenist_viewmode=='list-view'){ echo ' active';} ?>" title="<?php echo esc_attr__( 'List', 'javenist' ); ?>"></a>
											</div>
											<?php
												/**
